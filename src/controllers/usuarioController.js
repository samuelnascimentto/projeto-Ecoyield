            ...
            .then(
                function (resultadoAutenticar) {
                    ...
                    if (resultadoAutenticar.length == 1) {
                        ...
                        departamentoModel.buscarDepartamentosPorEmpresa(resultadoAutenticar[0].empresaId)
                            .then((resultadoDepartamentos) => {
                                if (resultadoDepartamentos.length > 0) {
                                    res.json({
...
function cadastrar(req, res) {
    ...
    if (nome == undefined) {
        ...
        usuarioModel.cadastrar(nome, sobrenome, rg, cpf, email, senha, empresaId)
            .then(
                function (resultado) {
                    res.json(resultado);
                }
